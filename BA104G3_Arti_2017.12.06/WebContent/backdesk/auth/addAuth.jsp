...
<table id="table-1">
	<tr><td>
		 ...
		 <h4><a href="<%=request.getContextPath()%>/selectAuth_page.jsp"><img src="images/tomcat.png" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
	<tr>
		...
		<td><input type="TEXT" name="auth_Name" size="45" 
			 value="<%= (authVO==null)? "XXX" : authVO.getAuth_Name()%>" /></td>
	</tr>
