...
<body id="page-top" style="font-family:Microsoft JhengHei;">
    ...
    <header class="masthead">
        <div class="container">
            ...
            <div class="intro-text">
                <span class="name">Pride Of Tool Man</span>
                <hr class="star-light">
                <span class="skills">工具人好評出租中！</span>
            </div>
        </div>
    </header>
            ...
            <div class="row">
                <div class="col-sm-4 portfolio-item">
                    <a class="portfolio-link" href="#portfolioModal1" data-toggle="modal">
                        ...
                        <img class="img-fluid smallimg" src="<%=request.getContextPath()%>/lib/publicfile/include/img/portfolio/indexPhoto_1.png" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a class="portfolio-link" href="#portfolioModal2" data-toggle="modal">
                        ...
                        <img class="img-fluid smallimg" src="<%=request.getContextPath()%>/lib/publicfile/include/img/portfolio/indexPhoto_2.png" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a class="portfolio-link" href="#portfolioModal3" data-toggle="modal">
                        ...
                        <img class="img-fluid smallimg" src="<%=request.getContextPath()%>/lib/publicfile/include/img/portfolio/indexPhoto_3.png" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a class="portfolio-link" href="#portfolioModal4" data-toggle="modal">
                        ...
                        <img class="img-fluid smallimg" src="<%=request.getContextPath()%>/lib/publicfile/include/img/portfolio/indexPhoto_4.png" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a class="portfolio-link" href="#portfolioModal5" data-toggle="modal">
                        ...
                        <img class="img-fluid smallimg" src="<%=request.getContextPath()%>/lib/publicfile/include/img/portfolio/indexPhoto_5.png" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a class="portfolio-link" href="#portfolioModal6" data-toggle="modal">
                        ...
                        <img class="img-fluid smallimg" src="<%=request.getContextPath()%>/lib/publicfile/include/img/portfolio/indexPhoto_6.png" alt="">
                    </a>
                </div>
            </div>
        </div>
    ...
    <%--     <script src="<%=request.getContextPath()%>/front/jquery-twzipcode-master/jquery.twzipcode.js"></script>
        <!-- 台灣地址選擇器 -->--%>
