...
DROP TABLE MISSION_COMMENT;             --任務評價
...
MISSION_NO VARCHAR2(20) NOT NULL,
COMMENT_DETAIL CLOB,
COMMENT_POINT NUMBER(2) NOT NULL,
COMMENT_TIME TIMESTAMP NOT NULL,
CONSTRAINT FK_RE FOREIGN KEY(REVIEWER) REFERENCES MEM(MEM_NO),
CONSTRAINT FK_LIS FOREIGN KEY(LISTENER) REFERENCES MEM(MEM_NO),
CONSTRAINT FK_MISSION FOREIGN KEY(MISSION_NO) REFERENCES MISSION(MISSION_NO),
CONSTRAINT PK_COMMENT PRIMARY KEY(REVIEWER,LISTENER,MISSION_NO)
);
...
REP_RE_DESC         VARCHAR2(200)NOT NULL,
